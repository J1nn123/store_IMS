...
<div x-data="{ open: false }" class="relative min-h-screen flex">
    ...
    <div
        ...
        class="fixed z-30 inset-y-0 left-0 w-64 bg-teal-700 text-white transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col">
    ...
    <div class="flex-1 flex flex-col min-h-screen bg-gray-100">
        ...
        <main class="flex-1 p-6">
            <!-- include your dashboard content -->
